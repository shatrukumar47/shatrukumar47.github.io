...
import ProjectCard from "../otherComponents/ProjectCard";
  ...
  return (
    ...
    >
      <div data-aos="fade-up">
        ...
        <Container
          maxW={{ base: "95%", md: "90%", lg: "86%", xl:"86%" }}
          display={"grid"}
          gridTemplateColumns={{base:"repeat(1, 1fr)", md:"repeat(1, 1fr)", lg:"repeat(2, 1fr)", xl:"repeat(2, 1fr)"}}
          gap={"40px"}
        >
